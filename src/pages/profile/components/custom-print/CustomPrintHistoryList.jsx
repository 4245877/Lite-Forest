...
function mapStatus(status) {
  return formatCustomPrintStatus(status, 'Чернетка');
}
...
export default function CustomPrintHistoryList({
  ...
  return (
    <section className={`${panel.card} ${custom.customPrintHistoryCard}`}>
      <h3 className={panel.cardTitle}>Мої моделі</h3>
            ...
            return (
              <div key={itemId} className={custom.customPrintHistoryItem}>
                ...
                >
                  ...
                  <span className={custom.customPrintHistoryBody}>
                    <span className={custom.customPrintHistoryHead}>
                      <span className={custom.customPrintHistoryTitle}>{title}</span>

                      <span className={`${statusClassName} ${custom.customPrintHistoryStatus}`}>
                        {statusLabel}
                      </span>
                    </span>

                    <span className={custom.customPrintHistoryMuted}>
                ...
                >
                  <Trash2 className={custom.customPrintButtonIcon} size={16} strokeWidth={2} aria-hidden="true" />
                  Видалити
                </button>
              </div>
            );
