      ...
      <div className={panel.card}>
        ...
        <form onSubmit={changePassword} noValidate>
          <div className={panel.inputGroup}>
            ...
            <div className={`${panel.controlRow} ${panel.passwordControl}`}>
              <input
                id="pwd-old"
              ...
              >
                <PasswordToggleIcon visible={show1} />
              </button>
            </div>
          </div>
          ...
          <div className={panel.inputGroup}>
            ...
            <div className={`${panel.controlRow} ${panel.passwordControl}`}>
              ...
              >
                <PasswordToggleIcon visible={show2} />
              </button>
            </div>
          </div>
          ...
          <div className={panel.inputGroup}>
            ...
            <div className={`${panel.controlRow} ${panel.passwordControl}`}>
              ...
              <button
                type="button"
                className={panel.iconButton}
                aria-label={show3 ? 'Сховати пароль' : 'Показати пароль'}
                aria-pressed={show3}
                onClick={() => setShow3((v) => !v)}
              >
                <PasswordToggleIcon visible={show3} />
              </button>
            </div>
          </div>
