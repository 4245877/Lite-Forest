// src/pages/LegalPages.jsx — повна сторінка
...
export default function LegalPages() {
  ...
  useEffect(() => {
    const targetId = hash?.slice(1) || "privacy";
    setActive(targetId);
  ...
  return (
    <main className="legal max-w-5xl mx-auto px-4 py-8">
      ...
      <section id="privacy" className="legal__section prose prose-neutral" style={{ scrollMarginTop: 96 }} aria-labelledby="privacy-title">
        ...
        <p>
          Ця Політика пояснює, як {COMPANY_NAME}{LEGIS(LEGAL_ENTITY)} (далі — «ми», «нас», «наш») збирає, 
          використовує, зберігає та захищає персональні дані користувачів під час відвідування сайту {WEBSITE_URL} 
          та користування нашими сервісами. Ми діємо відповідно до чинного законодавства України щодо захисту персональних даних 
          та загальновизнаних принципів конфіденційності.
        </p>
        ...
        <ul>
          ...
          <li>Email: {CONTACT_EMAIL}{CONTACT_PHONE ? `, Телефон: ${CONTACT_PHONE}` : ""}</li>
        </ul>
        ...
        <ul>
          ...
          <li><strong>Платіжні дані</strong>: токени/ідентифікатори платежів (обробка здійснюється платіжними провайдерами: {joinOrDash(THIRD_PARTIES.payments)}). Ми не зберігаємо повні реквізити карток.</li>
          <li><strong>Дані доставки</strong>: ПІБ одержувача, адреса/відділення, контакти (через служби доставки: {joinOrDash(THIRD_PARTIES.shipping)}).</li>
          <li><strong>Комунікації</strong>: звернення до підтримки, відгуки, участь в опитуваннях, підписка на розсилку.</li>
          <li><strong>Технічні дані</strong>: IP‑адреса, файли cookie, ідентифікатори пристрою/браузера, лог‑файли, події взаємодії (аналітика: {joinOrDash(THIRD_PARTIES.analytics)}).</li>
        </ul>
        ...
        <p>
          Ми ділимося даними лише в межах необхідного з постачальниками, які допомагають нам працювати:
        </p>
        <ul>
          <li>Платіжні провайдери: {joinOrDash(THIRD_PARTIES.payments)}.</li>
          <li>Служби доставки: {joinOrDash(THIRD_PARTIES.shipping)}.</li>
          <li>Аналітичні/маркетингові платформи: {joinOrDash(THIRD_PARTIES.analytics.concat(THIRD_PARTIES.marketing || []))}.</li>
        ...
        <p>
          Якщо дані передаються за межі України/ЄЕЗ, ми забезпечуємо належні гарантії захисту відповідно до загальноприйнятих стандартів.
        </p>

        <h3>6. Строки зберігання</h3>
        <p>
          Персональні дані зберігаються не довше, ніж це необхідно для цілей обробки та виконання вимог законодавства (зокрема обліку).
        </p>

        <h3>7. Ваші права</h3>
        <p>
          Ви маєте права: доступу, виправлення, видалення, обмеження обробки, заперечення, переносимості даних, а також право відкликати згоду.
          Щоб реалізувати права, звертайтесь: {CONTACT_EMAIL}. Також ви можете звернутися зі скаргою до уповноважених органів.
        </p>
        ...
        <h3>9. Безпека</h3>
        <p>
          Ми впроваджуємо технічні та організаційні заходи для захисту даних. Водночас жодна система не гарантує абсолютної безпеки.
        </p>

        <h3>10. Зміни цієї Політики</h3>
        <p>
          Ми можемо оновлювати Політику. Актуальна версія публікується на цій сторінці із зазначенням дати оновлення.
        </p>
      </section>
      ...
      <section id="terms" className="legal__section prose prose-neutral" style={{ scrollMarginTop: 96 }} aria-labelledby="terms-title">
        ...
        <p>
          Ця Угода регулює умови доступу та використання сайту {WEBSITE_URL} і сервісів {COMPANY_NAME}. 
        ...
        <ul>
          ...
          <li>Оплата здійснюється через платіжні сервіси: {joinOrDash(THIRD_PARTIES.payments)}. Безпека платежів забезпечується їхніми політиками.</li>
        ...
        <ul>
          <li>Доставка здійснюється службами: {joinOrDash(THIRD_PARTIES.shipping)}. Строки та тарифи — згідно з інформацією під час оформлення.</li>
        ...
        <p>
          Умови повернення/обміну та гарантійного обслуговування визначені на сторінці <Link to="/returns">/returns</Link> та застосовному законодавстві.
        </p>

        <h3>7. Дозволені та заборонені дії</h3>
        <ul>
          <li>Дотримуйтеся законодавства і поважайте інших користувачів.</li>
          <li>Заборонені: спроби несанкціонованого доступу, втручання у роботу сайту, шахрайство, публікація незаконного/образливого контенту, порушення прав ІВ.</li>
        </ul>

        <h3>8. Контент і права інтелектуальної власності</h3>
        <ul>
          <li>Контент сайту (дизайн, тексти, зображення, логотипи, код) належить {COMPANY_NAME} або використовується на законних підставах.</li>
          <li>Ви отримуєте обмежену невиключну ліцензію користування сайтом для особистих некомерційних цілей.</li>
          <li>Розміщуючи відгуки/матеріали, ви надаєте нам невиключну ліцензію на їх публікацію та використання з посиланням на вас (за потреби).</li>
        </ul>
        ...
        <ul>
          ...
          <li>Відповідальність {COMPANY_NAME} обмежується межами, дозволеними законодавством, і не включає непрямі збитки, втрату прибутку тощо.</li>
        </ul>

        <h3>10. Посилання третіх сторін</h3>
        <p>
          Сайт може містити посилання/віджети третіх осіб (напр., соцмережі). Ми не контролюємо їх контент та політики.
        </p>

        <h3>11. Форс‑мажор</h3>
        <p>
          Ми не несемо відповідальності за невиконання зобов’язань у результаті обставин непереборної сили.
        </p>

        <h3>12. Зміни Угоди</h3>
        <p>
          Ми можемо оновлювати цю Угоду. Нова редакція набирає чинності з моменту публікації на цій сторінці або з вказаної дати.
        </p>
      ...
      <section id="cookies" className="legal__section prose prose-neutral" style={{ scrollMarginTop: 96 }} aria-labelledby="cookies-title">
        ...
        <p>
          Ця Політика пояснює, які cookie та подібні технології ми використовуємо на {WEBSITE_URL}, з якою метою 
          і як ви можете керувати налаштуваннями.
        </p>
        ...
        <ul>
          ...
          <li><strong>Аналітичні</strong> — допомагають розуміти використання сайту й покращувати його (напр., {joinOrDash(THIRD_PARTIES.analytics)}).</li>
          <li><strong>Маркетингові</strong> — показ персоналізованої реклами та вимірювання її ефективності (напр., {joinOrDash(THIRD_PARTIES.marketing)}).</li>
        </ul>
        ...
        <p>
          Cookie, що встановлюються третіми сторонами ({joinOrDash((THIRD_PARTIES.analytics || []).concat(THIRD_PARTIES.marketing || []))}),
          регулюються політиками відповідних провайдерів.
        </p>
